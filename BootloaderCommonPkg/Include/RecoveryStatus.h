...
#define RECOVERY_REASON_SBL             0x01    // ACM or TCO detected SBL failure
#define RECOVERY_REASON_CSME            0x02    // CSME firmware failure (HFSTS)  [Phase 2]
#define RECOVERY_REASON_IOE             0x04    // IOE CSME firmware failure      [Phase 3]
// BIT3..BIT7 reserved for future failure sources
...
typedef struct {
  ...
  UINT8   Reserved;         // Alignment pad: ensures variable DataSize is even for LiteVariableLib
} RECOVERY_STATUS;
#pragma pack(pop)
